...
namespace libraryAutomation
{
    public partial class frmGiveBook : Form
    {
        ...
        private void frmGiveBook_Load(object sender, EventArgs e)
        {
            con.Open();
            tableMember.Clear();
            SqlDataAdapter adrMember = new SqlDataAdapter("select * from member order by name", con);
            ...
            tableBook.Clear();
            SqlDataAdapter adrBook = new SqlDataAdapter("select * from book order by book_title", con);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand com = new SqlCommand("insert into give_book (id_no,name,surname,tel,address,barcode_no,book_title,author,page_count,shelf_no,issue_date,submission_date)" +
